...
@section('title', 'Contact - PostinAJA')
                    ...
                    <div class="card mb-4 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <div class="container"> 
                                ...
                                <ul>
                                    <li><strong>Berinteraksi:</strong> Tinggalkan jejakmu di kolom komentar. Kami senang membaca setiap respons dan masukan.</li>
                                    ...
                                    <li><strong>Jadi Kontributor:</strong> Punya cerita yang ingin kamu bagikan? Kami membuka pintu untuk penulis tamu. Kunjungi halaman <a href="mailto:rahmatirfanap@gmail.com">"Kirim Tulisan"</a> untuk info lebih lanjut.</li>
                                </ul>
                                <p class="signature">
